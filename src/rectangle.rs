...
impl<Bound> PartialEq<Rect<Bound>> for Rect<Bound>
where
    Bound: Width + Num,
{
...
impl<Bound> Bounded for Rect<Bound>
where
    Bound: Num + Width + Clone,
{
    fn lower(&self) -> Point<Bound> {
        debug_assert!(
            !self.is_empty(),
            "Cannot access lower bound on empty rectangle."
        );
        self.low()
    }
    ...
    fn upper(&self) -> Point<Bound> {
        debug_assert!(
            !self.is_empty(),
            "Cannot access upper bound on empty rectangle."
        );
        self.up()
    }
}

impl<Bound> Singleton for Rect<Bound>
where
    Bound: Width + Clone,
{
...
impl<Bound> Empty for Rect<Bound>
where
    Bound: Width + Num,
{
    fn empty() -> Rect<Bound> {
...
impl<Bound> Whole for Rect<Bound>
where
    Bound: Width + Num,
{
    fn whole() -> Rect<Bound> {
...
impl<Bound> Disjoint for Rect<Bound>
where
    Bound: Width + Num,
{
...
impl<Bound> Disjoint<Bound> for Rect<Bound>
where
    Bound: Num + Ord,
{
...
impl<Bound> Disjoint<Optional<Bound>> for Rect<Bound>
where
    Bound: Num + Ord,
{
...
impl<Bound> Overlap for Rect<Bound>
where
    Bound: Width + Num,
{
...
impl<Bound> Overlap<Bound> for Rect<Bound>
where
    Bound: Width + Num,
{
...
impl<Bound> Overlap<Optional<Bound>> for Rect<Bound>
where
    Bound: Width + Num,
{
...
impl<Bound> Hull for Rect<Bound>
where
    Bound: Width + Num,
{
    ...
    fn hull(&self, other: &Rect<Bound>) -> Rect<Bound> {
        if self.is_empty() {
            ...
            Rect::new(min(self.low(), other.low()), max(self.up(), other.up()))
        }
    }
}

impl<Bound> Hull<Bound> for Rect<Bound>
where
    Bound: Width + Num,
{
    type Output = Rect<Bound>;
...
impl<Bound> Contains for Rect<Bound>
where
    Bound: Ord,
{
...
impl<Bound> Subset for Rect<Bound>
where
    Bound: Width + Num,
{
...
impl<Bound> ProperSubset for Rect<Bound>
where
    Bound: Width + Num,
{
...
impl<Bound> Intersection for Rect<Bound>
where
    Bound: Width + Num,
{
    type Output = Rect<Bound>;
    ...
    fn intersection(&self, other: &Rect<Bound>) -> Rect<Bound> {
        Rect::new(max(self.low(), other.low()), min(self.up(), other.up()))
    }
}

impl<Bound> Intersection<Bound> for Rect<Bound>
where
    Bound: Width + Num,
{
    type Output = Rect<Bound>;
...
impl<Bound> Intersection<Optional<Bound>> for Rect<Bound>
where
    Bound: Width + Num,
{
    type Output = Rect<Bound>;
    ...
    fn intersection(&self, value: &Optional<Bound>) -> Rect<Bound> {
        value
            .as_ref()
            .map_or(Rect::empty(), |x| self.intersection(x))
    }
}
...
impl<Bound> Difference for Rect<Bound>
where
    Bound: Width + Num,
{
    type Output = Rect<Bound>;
...
impl<Bound> Difference<Bound> for Rect<Bound>
where
    Bound: Num + Clone,
{
    type Output = Rect<Bound>;
...
impl<Bound> Difference<Optional<Bound>> for Rect<Bound>
where
    Bound: Ord + Num + Clone,
{
    type Output = Rect<Bound>;
...
impl<Bound> ShrinkLeft for Rect<Bound>
where
    Bound: Num + Width,
{
...
impl<Bound> ShrinkRight for Rect<Bound>
where
    Bound: Num + Width,
{
...
impl<'a, 'b, Bound> Add<&'b Rect<Bound>> for &'a Rect<Bound>
where
    Bound: Num + Width,
{
    type Output = Rect<Bound>;
...
impl<'a, 'b, Bound> Add<&'b Bound> for &'a Rect<Bound>
where
    Bound: Num + Width + Clone,
{
    type Output = Rect<Bound>;
...
impl<'a, 'b, Bound> Sub<&'b Rect<Bound>> for &'a Rect<Bound>
where
    Bound: Num + Width,
{
    type Output = Rect<Bound>;
...
impl<'a, 'b, Bound> Sub<&'b Bound> for &'a Rect<Bound>
where
    Bound: Num + Width + Clone,
{
    type Output = Rect<Bound>;
...
impl<'a, 'b, Bound> Mul<&'b Rect<Bound>> for &'a Rect<Bound>
where
    Bound: Num + Width,
{
    type Output = Rect<Bound>;
...
impl<'a, 'b, Bound> Mul<&'b Bound> for &'a Rect<Bound>
where
    Bound: Num + Width + Clone,
{
    type Output = Rect<Bound>;
...
impl<Bound> Display for Rect<Bound>
where
...
impl<Bound> Join for Rect<Bound>
where
    Bound: Width + Num,
{
...
impl<Bound> Meet for Rect<Bound>
where
    Bound: Width + Num,
{
...
impl<Bound> Entailment for Rect<Bound>
where
    Bound: Width + Num,
{
...
mod tests {
    ...
    fn is_disjoint_option_test() {
        let mut cases: Vec<(u32, Rect<i32>, Optional<i32>, bool)> = is_disjoint_cases()
            .into_iter()
